...
class ExampleTest {
    ...
    fun testLocationRecords() = Csv {
        ...
        expected = """
            ...
            |0,2020-02-01T13:33,0.0,0.0,12,Jon,Smith,,f9682dcb-30f7-4e88-915e-60e3b2758da7,CAR,Tesla,,Unknown,,
            |1,2020-02-01T13:37,0.1,0.1,12,Jon,Smith,,f9682dcb-30f7-4e88-915e-60e3b2758da7,CAR,Tesla,27.7778,Electric,,18.1
            |9000,2020-02-05T07:59,48.137154,11.576124,42,Jane,Doe,1581602631744,c038c27b-a3fd-4e35-b6ac-ab06d747e16c,MOTORBIKE,Harley,20.0,Combustion,7.9,
        """.trimMargin(),
        original = listOf(
            LocationRecord(
                id = 0,
