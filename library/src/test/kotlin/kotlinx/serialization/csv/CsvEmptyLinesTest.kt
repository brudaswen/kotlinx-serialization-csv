...
class CsvEmptyLinesTest {
    ...
    fun testIntList() = assertParse(
            ...
            listOf(-150, 150, 42),
            Int.serializer().list,
            Csv(CsvConfiguration(ignoreEmptyLines = true))
    )
    ...
    fun testRecordList() = assertParse(
            "\r\n\r\n1,testing\r\n\r\n2,bar\r\n\r\n",
            listOf(IntStringRecord(1, "testing"), IntStringRecord(2, "bar")),
    ...
    fun testRecordListWithHeaders() = assertParse(
            ...
            listOf(IntStringRecord(1, "testing"), IntStringRecord(2, "bar")),
            IntStringRecord.serializer().list,
            Csv(CsvConfiguration(ignoreEmptyLines = true, hasHeaderRecord = true))
    )
    ...
    fun testNullRecordList() = assertParse(
            "\r\n\r\nnull\r\n\r\nnull\r\n\r\n",
            listOf(NullRecord(null), NullRecord(null)),
            NullRecord.serializer().list,
            Csv(CsvConfiguration(ignoreEmptyLines = true, nullString = "null"))
    )
    ...
    fun testNullRecordListWithEmptyNullString() = assertParse(
            ...
            listOf(),
            NullRecord.serializer().list,
            Csv(CsvConfiguration(ignoreEmptyLines = true, nullString = ""))
    )
}
