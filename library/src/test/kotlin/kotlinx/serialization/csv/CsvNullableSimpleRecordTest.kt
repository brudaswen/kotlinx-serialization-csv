...
/**
 * Test [Csv] ([CsvEncoder] and [CsvDecoder]) with simple nullable [Serializable] records.
 */
class CsvNullableSimpleRecordTest {
    ...
    fun testIntList() = assertStringFormAndRestored(
            "-150\r\n\r\n150",
            listOf(IntRecord(-150), null, IntRecord(150)),
    ...
    fun testIntListWithLastLineEmpty() = assertParse(
            "-150\r\n\r\n150\r\n",
            listOf(IntRecord(-150), null, IntRecord(150), null),
            IntRecord.serializer().nullable.list,
            Csv(CsvConfiguration(ignoreEmptyLines = false))
    )
}
